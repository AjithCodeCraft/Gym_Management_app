...
export default function HomeScreen() {
   ...
   const [streakData, setStreakData] = useState<StreakDataType>({
      currentStreak: 1, // Infinite streak counter
   ...
   const showStreakData = () => {
    return (
      <View style={styles.chartCenterText}>
        <Text style={styles.streakNumber}>{streakData.currentStreak} 
         ...
         <View style={styles.section}>
            ...
            {bmi && (
               <View style={styles.resultContainer}>
                  ...
                  <Text style={[styles.resultLevel, getBmiLevelStyle(bmiLevel)]}>Level: {bmiLevel}</Text>
               </View>
            )}
         </View>
      </ScrollView>
