    ...
    <View style={styles.gymDetailsContainer}>
      ...
      {trainers.map((trainer) => (
        <View key={trainer.id} style={styles.trainerDetailsContainer}>
          ...
          <Text style={styles.trainerSpecialization}>Specialization: {trainer.specialization}</Text>
          <Text style={styles.trainerExperience}>Experience: {trainer.experience}</Text>
          <Text style={styles.trainerAvailability}>Availability: {trainer.availability}</Text>
        </View>
      ))}
    </View>
  );
