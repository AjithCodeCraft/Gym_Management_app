...
from .views import (add_subscription, delete_all, delete_subscription, get_user_by_firebase_id, list_subscriptions, list_trainers, list_users,
    ...
    remove_trainer, view_assigned_trainer_for_user, view_assigned_trainers, view_assigned_users_for_trainer)
